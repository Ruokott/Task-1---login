function myLogin(form) {
    username = new Array("admin","u2","u3","u4","u5","u6","u7","u8","u9","u10");
    password = new Array("admin","p2","p3","p4","p5","p6","p7","p8","p9","p10");
    page = "www.google.com";
...
function myFunction(form1) {
   <button type="button" onclick="myFunction(this.myform);">Nappi</button>
